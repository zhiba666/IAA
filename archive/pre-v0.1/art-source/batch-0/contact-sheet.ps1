...
$items=(Get-Content -LiteralPath (Join-Path $taskRoot 'assets/art/manifest.json') -Raw | ConvertFrom-Json).entries
$sheet=[Drawing.Bitmap]::new(1600,1750)
...
$g.DrawString('POPCORN FACTORY / ART SAMPLE 00',$title,$ink,30,24)
$g.DrawString('19 transparent parts | teal machinery / red-white cups / cream and gold UI',$font,$muted,34,88)
$i=0
...
$g.DrawString('ARTWORK ONLY - independent exports; no game integration. Editable layout and source sheets included.',$font,$muted,34,1720)
