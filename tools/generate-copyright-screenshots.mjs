...
const directory=path.join(root,'docs/copyright/screenshots');await mkdir(directory,{recursive:true});
function state(){
...
const views=[
  ...
  {name:'02-main',caption:'主界面与设备升级',description:'示例金币、当前订单、生产区域、能量条和三项升级。界面状态标注浏览器激励模拟。',ui:{}},
...
for(const view of views){
  ...
  const ui={tab:'upgrades',modal:null,toast:'',saved:true,isDouyin:false,startup:false,sidebarBusy:false,
...
await writeFile(path.join(root,'docs/copyright/screenshots.json'),JSON.stringify(metadata,null,2)+'\n');
