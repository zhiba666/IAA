...
const port = Number(process.env.IAA_SCENE_ART_PORT || process.argv[2] || 4175);
...
const server = http.createServer((request, response) => {
  ...
  if (pathname === '/') pathname = '/art-source/v1.3-scenes/index.html';
...
server.listen(port, '127.0.0.1', () => console.log(`Scene-art preview: http://127.0.0.1:${port}/art-source/v1.3-scenes/`));
