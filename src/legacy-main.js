'use strict';
function startLegacyGame(suppliedPlatform, suppliedSave, notice) {
...
const platform = suppliedPlatform || createPlatform();
const canvas = platform.canvas, ctx = canvas.getContext('2d'), sound = new AudioEngine();
const initialSave = suppliedSave === undefined ? platform.load() : suppliedSave, initialLoadError = platform.lastStorageError;
...
if (ui.loadError || notice) toast(ui.loadError || notice);
save();
...
module.exports = { startLegacyGame };
